...
import 'package:municpality_app/models/device_id_response.dart';
...
class _UpdateDeviceIDState extends State<UpdateDeviceID> {
  ...
  Future checkDeviceID() async {
    ...
    final response = await http.get(
      Uri.parse("http://mis.godawarimun.gov.np/Api/Attendence/GetDeviceId"),
  ...
  usedDeviceID() {
    showDialog<String>(
      ...
      builder: (BuildContext context) => AlertDialog(
        title: const Text(
            "तपाइको मोबाइल सेट [फलानोको नाममा, Mobile no] भेरिफाई भएको छ ।"),
        content: const Text("सच्याउन पर्ने भए एडमिनलाई सम्पर्क गर्नुहोला ।"),
        actions: [
          TextButton(
              onPressed: () {
                Navigator.pop(context);
